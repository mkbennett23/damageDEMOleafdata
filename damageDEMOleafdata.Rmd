...
emmeans(herbivoryAgeBeech_lm, pairwise~as.factor(plot_age)*as.factor(Age_class), adjust="tukey", type = "response")
```
...
```{r}
herbivoryAgeSG_lm <- glmm(Percent_total_herbivory~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 1 & Species == "Sweet gum"), family = genpois)
...
```{r}
herbivoryAgeSG2_lm <- glmm(Percent_total_herbivory~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 2 & Species == "Sweet gum"), family = genpois)
...
```{r}
herbivoryAgeTP_lm <- glmm(Percent_total_herbivory~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 1 & Species == "Tulip poplar"), family = genpois)
...
```{r}
herbivoryAgeTP2_lm <- glmm(Percent_total_herbivory~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 2 & Species == "Tulip poplar"), family = genpois)
...
```{r}
microbialAgeBeech_lm <- glmm(Percent_microbial~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 1 & Species == "Beech"), family = genpois)
...
```{r}
microbialAgeBeech2_lm <- glmm(Percent_microbial~ Age_class*plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 2 & Species == "Beech"), family = genpois)
...
```{r}
microbialAgeSG_lm <- glmm(Percent_microbial~ Age_class*Plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 1 & Species == "Sweet gum"), family = genpois)
```

```{r}
microbialAgeSG2_lm <- glmm(Percent_microbial~ Age_class*Plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 2 & Species == "Sweet gum"), family = genpois)
```


```{r}
microbialAgeTP_lm <- glmm(Percent_microbial~ Age_class*Plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 1 & Species == "Tulip poplar"), family = genpois)
```


```{r}
microbialAgeTP2_lm <- glmm(Percent_microbial~ Age_class*Plot_age+(1|Plot/Tree_num), data = subset(damagePlots, Sample_period == 2 & Species == "Tulip poplar"), family = genpois)
```
