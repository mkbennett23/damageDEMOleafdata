...
damageOct$Age_class <- factor(damage1$Age_class, levels = c("Sapling", "Mature"))
damageJuly$Age_class <- factor(damage2$Age_class, levels = c("Seedling", "Sapling", "Mature"))
...
damageJuly$Percent_total_herbivory <- as.integer(as.numeric(damage2$Percent_total_herbivory))
