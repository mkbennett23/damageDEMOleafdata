...
```{r}
herbChewingModel <- glmm(Percent_chewed~ Species*Age_class*Sample_period+(1|Plot/Tree_num), data = damagePlots, family = genpois)
...
```{r}
herbMiningModel <- glmm(Percent_mined~ Species*Age_class*Sample_period+(1|Plot/Tree_num), data = damagePlots, family = genpois)
...
```{r}
herbSkeletonizingModel <- glmm(Percent_skeletonized~ Species*Age_class*Sample_period+(1|Plot/Tree_num), data = damagePlots, family = genpois)
...
```{r}
herbGallModel <- glmm(Percent_gall~ Species*Age_class*Sample_period+(1|Plot/Tree_num), data = damagePlots, family = genpois)
